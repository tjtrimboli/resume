...
% \item Served as a trusted advisor to new and existing customers and partners to drive positive outcomes and deliver value.
...
\item Championed the improvement of customer satisfaction by creating a white-glove service offering.
\item Expanded content creation through technical documentation and introduced a product, "shorts," video series.
\item Provided client services centered around deployment, training, integration support, and troubleshooting.
\item Contributed to the development and testing of front-end and back-end components, integrations, and other applications.
\resumeItemListEnd
