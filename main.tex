...
\end{itemize}
\item Managed North America, including commercial, federal, and DoD customers ranging from SMBs to\
enterprise-level organizations comprising the Fortune 50, 100, and 500 lists.
\item Served as a trusted advisor to new and existing clients and partners to drive positive outcomes and deliver value.
...
\item Prioritized gathering customer feedback and requirements to align product roadmap priorities with customer needs.
\item Championed the creation of a new white-glove service offering and product "shorts" video series.
